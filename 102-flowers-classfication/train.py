...
val_data = datasets.ImageFolder(val_dir,transform=val_test_trans)
test_data = datasets.ImageFolder(test_dir,transform=val_test_trans)
        ...
        for inputs, labels in trainloader:
            ...
            if steps % print_every == 0:
                ...
                print( f"Training loss: {train_loss/print_every:.3f},"
                    ...
                    f"Validation accuracy: {val_accuracy/len(valloader):.3f} \n")
                train_loss = 0.0
                model.train()
